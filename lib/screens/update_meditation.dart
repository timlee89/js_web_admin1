...
class UpdateMeditation extends StatelessWidget {
  static const String id = "update-meditation";
  const UpdateMeditation({Key? key}) : super(key: key);
      ...
      child: Column(
        ...
        children: [
          ...
          const Padding(
            padding: EdgeInsets.symmetric(vertical: 5, horizontal: 20),
            child: Text(
              "meditation 내용 수정. \n \n  list에서 선택해도 여기로 온다. \n Firestore data를 가져와서 input field에 보여준다.  필요한 수정을 한 후 update 클릭하면, DB update하면서 List Page로 이동함 \n  이미지 등 파일도 다시 교체할 수 있다",
              style: TextStyle(fontSize: 14, color: Colors.red),
            ),
          ),
          const SizedBox(
